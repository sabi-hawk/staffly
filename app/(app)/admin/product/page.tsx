  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Section title="CRM & deals">
        <ul>
          <li>CRM Leads is one hub keyed by company (Leads cards / Interviews / Assessments), with per-lead documents, job description, BD notes, and company contacts. The Leads list opens on <strong>In progress</strong> by default.</li>
