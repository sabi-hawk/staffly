    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Section title="CRM & deals">
        <ul>
          ...
          <li><strong>Job Hunt Board</strong> (<code>/crm/job-board</code>): a shared, <strong>live</strong> board where BDs log hunted job posts (company, position, job-post link + copy, stack). Every field is optional. All BDs see every row in real time; own rows are tagged <strong>You</strong>. <strong>Repeated companies are colour-coded</strong> by how many BDs added them; <strong>bulk-paste</strong> many URLs at once (de-duped vs the paste and the board); filter by BD / company / position; expand a row to edit (owner edits all fields; any BD edits the shared <strong>feedback</strong> and can <strong>dismiss</strong> a post with a reason, kept struck-through for the record).</li>
