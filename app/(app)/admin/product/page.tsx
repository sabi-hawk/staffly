    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Section title="CRM & deals">
        <ul>
          ...
          <li>A <strong>deal</strong> records a <strong>Closer</strong> (who landed it) and an optional <strong>BD owner</strong> and <strong>working developer</strong>; the CRM <strong>lead is optional</strong> (deals can predate the portal). Each deal has a unique <strong>4-digit code</strong>, so a company with several deals stays unambiguous. The list has <strong>Edit</strong> and <strong>Delete</strong> per profile.</li>
