...
import { addPayslipLine, removePayslipLine, setPayslipLineDismissed } from "@/lib/services/payroll";

// PATCH toggles a line's dismissed flag (kept for the record, excluded from totals).
export async function PATCH(request: Request, { params }: { params: { id: string } }) {
  ...
  try {
    const run = await setPayslipLineDismissed(supabase, body.lineId, params.id, !!body.dismissed);
